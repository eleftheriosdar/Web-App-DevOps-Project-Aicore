...
key_vault_url = "https://lefterisvault.vault.azure.net/"
...
serverpassword = serverpassword.get_secret("serverpassword")
serverusername = serverusername.get_secret("serverusername")
database = database.get_secret("database")
servername = servername.get_secret("servername")
